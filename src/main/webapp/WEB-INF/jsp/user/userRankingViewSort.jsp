...
<div class="container"> 
	<p class="rank-info">
   	...
   	<p class="align-buttons">
   		...
   		<button class="follower_align_button btn">팔로워순</button>
   			<button class="postLike_align_button btn">추천순</button>
   		<button class="view_align_button btn" data-align-id=1>조회순</button>
   	</p>
...
<script>
	$(document).ready(function() {
		$('.view_align_button').on('click', function(){
			let alignId = 1;
			$.ajax({
				type:"GET"
				, url: "/cook/user-ranking/" + alignId
				, data : {}
