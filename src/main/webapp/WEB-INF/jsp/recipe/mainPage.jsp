			...
			<li>
				...
				<c:if test="${recipeView.user.id eq userId}">	
					<div class="btn-group" style="width:50px; height:30px;">
							<a class="handle-post-btn btn" data-toggle="dropdown" href="#"><svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
